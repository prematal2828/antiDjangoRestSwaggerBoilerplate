...
SPECTACULAR_SETTINGS = {
    "TITLE": "Todo API",
    "DESCRIPTION": (
        "A production-ready Django REST Framework boilerplate featuring:\n"
        "- Fully custom User model (email-based auth)\n"
        "- JWT authentication (access + refresh tokens)\n"
        "- Todo CRUD with per-user isolation\n"
        "- Auto-generated OpenAPI 3.0 schema (Swagger UI + ReDoc)"
    ),
    "VERSION": "1.0.0",
